import{d as a,f as m,T as u,c as f,F as w,r as l,j as t,S as C,a as $,p as b,b as k,k as y}from"./index-B17MNmM0.js";import{b as j}from"./background-DhGLTqEF.js";const v=a(u).withConfig({shouldForwardProp:e=>e!=="isChecked"})`
...
`,P=a.img`
  ...
  filter: grayscale(1);
  transition: 0.4s;
`,L=()=>{const[e,s]=l.useState(!1),[d,h]=l.useState([]),p=(i,r)=>{const{naturalWidth:o,naturalHeight:n}=r.target,g=o/n;h(x=>{const c=[...x];return c[i]=g,c})};return t.jsxs(C,{"aria-label":"achievements section",flexDirection:"column",gap:"10px",children:[t.jsx($,{alt:"Hero",fetchpriority:"high",width:1572,height:620,decoding:"async",src:j}),t.jsx("input",{type:"checkbox",id:"click",checked:e,onChange:()=>s(!e),style:{display:"none"}}),t.jsx(v,{isChecked:e,padding:"20px 0 0 0",children:"Some of my achievements are listed below"}),t.jsx(I,{isChecked:e,alignItems:"center",justifyContent:"center",width:"100%",gap:"20px",flexWrap:"wrap",position:"relative",children:b.achievements.map(({src:i,srcset:r},o)=>t.jsx(F,{htmlFor:"click",position:o,isChecked:e,aspectRatio:d[o],children:t.jsx(P,{src:i,srcSet:r,alt:`Achievement ${o+1}`,onLoad:n=>p(o,n)})},o))}),t.jsx(S,{isChecked:e,padding:"0 0 20px 0",children:"More will be added soon ..."}),t.jsx(k,{to:y,children:"Let's Connect 🤝 ➾"})]})};export{L as default};
